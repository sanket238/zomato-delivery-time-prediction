...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        # set tags
        mlflow.set_tag("model","Zomato  Delivery Time Regressor")
        ...
        #train_data_input=train_data.to_csv("train_data.csv", index=False)
        #test_data_input=test_data.to_csv("test_data.csv", index=False)
