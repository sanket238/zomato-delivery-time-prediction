...
def data_cleaning(data: pd.DataFrame):
    ...
    return (
        ...
        .drop(columns=["order_time","order_picked_time","time_converted"])
    )
...
if __name__ == "__main__":
    ...
    cleaned_data_filename = "zomato_dataset_cleaned.csv"
    # data save path
    cleaned_data_save_path = cleaned_data_save_dir / cleaned_data_filename
    # data load path
    data_load_path = root_path / "data" / "raw" / "zomato_dataset.csv"
